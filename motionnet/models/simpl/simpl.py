...
############################################################################################################
        ...
        output_dict = dict()
        output_dict['predicted_probability'] = out_post['prob_pred'] 
        output_dict['predicted_trajectory'] = out_post['traj_pred']
    ...
    def get_loss(self, out, data):
        loss_dict = self.lossFunc(out, data)
        loss = loss_dict['loss']
        return loss
    ...
    def configure_optimizers(self):
        ...
        opt = Optimizer(self.parameters(), self.config)
